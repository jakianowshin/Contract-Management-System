...
public class ProjectDetailAdapter2  extends ArrayAdapter<ProjectDetail2> {

    private List<ProjectDetail2> list;

    private LayoutInflater inflator;


    public ProjectDetailAdapter2(Activity context, List<ProjectDetail2> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ProjectDetailAdapter.ProjectDetailHolder ProjectDetailHolder;
        ...
        if(convertView == null){
            ...
            ProjectDetailHolder = new ProjectDetailAdapter.ProjectDetailHolder();
